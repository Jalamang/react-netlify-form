...
const About = ({ currBGColor }) => {
  return (
    <main style={{ backgroundColor: currBGColor }}>
        ...
        <img className="project-pic" alt="project-pic" src={projectPic}/>
      ...
      <img className="team-pic" alt="team-pic" src={teamPic}/>
      <article className="team-description">
        ...
        >
          ...
          <a 
            ...
            rel="noreferrer"
            >
               <img src ={linkedInLogo}  alt="linkedInLogo" className="logos"/> 
          </a>
          <a 
            href='https://twitter.com/JoinPursuit'
            target="_blank"
            rel="noreferrer">
               <img src ={twitterLogo} alt="twitterLogo" className="logos-resize"/>
          </a>
          ...
          <a 
            ...
            target="_blank"
            rel="noreferrer">
               <img src ={githubLogo} alt="twitterLogo" className="logos-resize" />
          </a>
        </a>
      ...
      <div className="about-ki-sub-profile">
        ...
        >
          ...
          <a 
            ...
            target="_blank"
            rel="noreferrer">
               <img src ={linkedInLogo} alt="linkedInLogo" className="logos"/> </a>
          <a 
            href='https://twitter.com/JoinPursuit'
            target="_blank"
            rel="noreferrer">
          ...
          <a 
            ...
            target="_blank"
            rel="noreferrer">
               <img src ={githubLogo} alt="githubLogo" className="logos-resize" />
          </a>
        </a>
